...
import { PrettyJSON } from '../ui/terminal';
...
export const About: FC = () => (
  <section
    ...
    aria-label={t`About information`}
  >
    <div className="mb-10 flex flex-col items-center gap-8 md:flex-row">
      <div className="flex-1">
        <h1 className="mb-4" tabIndex={0}>{t`Once upon a time...`}</h1>
        <p className="mb-4">
          <Trans>
            ...
            engineer, always driven by a passion for creating meaningful digital
            experiences.
          </Trans>
        </p>
      </div>
    ...
    <div className="mb-10 flex flex-col-reverse items-center gap-8 md:flex-row">
      <figure className="flex flex-1 justify-center">
        <img
          ...
          tabIndex={0}
        />
        <figcaption className="sr-only">{t`Young Henrique coding at home, 2010`}</figcaption>
      </figure>
      <div className="flex-1">
        <h2 className="mb-2">{t`A Lifelong Learner`}</h2>
        <p className="mb-4">
          <Trans>
            ...
            project a new adventure. My curiosity led me to wear many hats, from
            tech support to cloud engineering.
          </Trans>
        </p>
      </div>
    </div>
    ...
    <div className="mb-10 ml-3 flex flex-col items-center gap-6 md:flex-row">
      <div className="flex-1">
        <h2 className="mb-2">{t`Beyond the Code`}</h2>
        <p className="mb-4">
          <Trans>
      ...
      <div className="flex-1">
        <YoutubeWidget
          ...
          title={t`Henrique playing piano`}
        />
      </div>
    </div>
    ...
    <div className="mb-10 flex flex-col items-center md:gap-8">
      <div className="flex-1">
        <h2 className="mb-2">{t`Code is My Craft`}</h2>
        <p className="mb-4">
          <Trans>
            I believe in the power of clean, efficient code to solve real-world
            problems. Whether building APIs, designing UIs, or architecting
            cloud solutions, I strive for excellence and simplicity.
          </Trans>
        </p>
      </div>
      <div className="not-prose w-full flex-1">
        <Windows96
          title={t`Help Topics: Windows`}
          ...
          <pre className="">
            <PrettyJSON
              json={{
                ...
                hobbies: [t`Music`, t`Gaming`, t`Reading`],
                skills: [
                  'JavaScript',
                  'TypeScript',
                  'React',
                ...
                experience: t`'10+ years in software development'`,
              }}
            />
          </pre>
        </Windows96>
    ...
    <h4 className="font-medium">
      <Trans>
        My journey is far from over. I’m always seeking new challenges, eager to
        collaborate, and passionate about building solutions that make a
