...
const ContactLinks: React.FC<{ i18n: I18n }> = ({ i18n }) => (
  ...
  >
    <a
      ...
      className="inline-flex min-h-[44px] min-w-[44px] items-center rounded bg-green-500 px-4 py-2 text-sm text-white hover:bg-green-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-green-500 focus-visible:ring-offset-2"
    >
      {/* WhatsApp icon */}
      <svg
    ...
    <a
      ...
      className="inline-flex min-h-[44px] min-w-[44px] items-center rounded bg-blue-500 px-4 py-2 text-sm text-white hover:bg-blue-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2"
    >
      {/* Telegram icon */}
      <svg
        xmlns="http://www.w3.org/2000/svg"
    ...
    <a
      ...
      className="inline-flex min-h-[44px] min-w-[44px] items-center rounded bg-blue-700 px-4 py-2 text-sm text-white hover:bg-blue-800 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-700 focus-visible:ring-offset-2"
    >
      {/* LinkedIn icon */}
      <svg
        xmlns="http://www.w3.org/2000/svg"
...
const Contact: FC = memo(() => {
  ...
  return (
    <div className="not-prose -mt-3 flex flex-col gap-3" role="region">
