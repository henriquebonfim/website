...
const LIST_PERSONAL_PROJECTS: ReadonlyArray<Project> = [
  {
    ...
    image:
      "https://raw.githubusercontent.com/henriquebonfim/tick3r/main/public/og-image.webp",
  ...
  },
  {
    ...
    image:
      "https://raw.githubusercontent.com/henriquebonfim/ai-chat/main/chat.png",
  ...
  },
  {
    ...
    image:
      "https://raw.githubusercontent.com/henriquebonfim/ultra-dl/main/image.gif",
  ...
  },
  {
    ...
    image:
      "https://raw.githubusercontent.com/henriquebonfim/premium-blogger/v2/docs/image.png",
  ...
  },
  {
    ...
    image:
      "https://raw.githubusercontent.com/henriquebonfim/ArduEVE/master/Ardueve.png",
  ...
  },
  {
    ...
    image:
      "https://raw.githubusercontent.com/henriquebonfim/pet-porta-app/v1.0/png/inicio-login.png",
  ...
  },
  {
    ...
    image:
      "https://raw.githubusercontent.com/henriquebonfim/MegaHack-v2-2020-Projeto-Mideal/master/mideal-logo-white.png",
  ...
  },
  {
    ...
    image:
      "https://raw.githubusercontent.com/henriquebonfim/HackathonCCR/master/canivete.png",
    ...
    <div className="group relative flex flex-col bg-base-primary border-2 border-base-content/20 hover:border-primary transition-colors duration-300">
      ...
      <div className="flex items-center gap-1 px-2 py-1 border-b-2 border-base-content/20 bg-base-200/50">
        ...
        <div className="ml-auto text-[10px] font-mono opacity-50">
          ~/projects/
          {project.title.toLowerCase().replace(/\s+/g, "-").slice(0, 16)}
        </div>
      </div>
...
export const Projects: FC = memo(() => {
  ...
  return (
    ...
    >
      ...
      <hr
        className="divider divider-neutral w-1/3 mx-auto my-4"
        role="separator"
      />
    </div>
  );
