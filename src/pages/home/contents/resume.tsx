...
export const Resume: FC = () => (
  <article
    className="prose flex max-w-none flex-col border-2 p-3 text-left font-serif"
    aria-label={t`Resume`}
  >
      ...
      <section className="mb-8">
        ...
        <p>
          <Trans>
            ...
            development (JavaScript, TypeScript, Node.js). Expertise in scalable
            microservices, serverless, and event-driven architectures. Proven
            success across fintech, government, and startups, with a passion for
            generative AI and performance optimization.
          </Trans>
        </p>
      </section>
      <section className="mb-8">
        ...
        <ul className="list-none p-0">
          ...
          <li className="mb-4">
            ...
            <ul className="list-disc pl-5">
              ...
              <li>
                <Trans>
                  Improved platform stability and facilitated project alignment.
                </Trans>
              </li>
            </ul>
          </li>
          ...
          <li className="mb-4">
            ...
            <ul className="list-disc pl-5">
              ...
              <li>
                <Trans>
                  Modernized KYC stack and optimized OAuth2 and SQL performance.
                </Trans>
              </li>
              <li>
          ...
          <li className="mb-4">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between">
              ...
              <span className="text-sm italic">
                <Trans>Technical Support Assistant</Trans> | <Trans>May</Trans>{' '}
                2013 – <Trans>Dec</Trans> 2014
              </span>
            </div>
            <ul className="list-disc pl-5">
              <li>
